...
# ╔═╡ 75eadb7f-3a30-4833-842a-a5aaa0f93d1b
begin
	using StatsPlots, Statistics
	using GLM, DataFrames, DataFramesMeta, RDatasets, CSV
	using LinearAlgebra, Random
end

# ╔═╡ 029c673e-8956-11ec-23d9-8bc9d4c6a4bc
md"# Least Squares"

# ╔═╡ 05c3cdc1-0ba2-42cb-990b-a593e1c01ddf
mtcars = RDatasets.dataset("datasets", "mtcars")

# ╔═╡ d4697e73-9505-46fa-93b2-3b8d0390963a
ols = lm(@formula(MPG ~ WT), mtcars)

# ╔═╡ c401c5a1-c3bb-43ed-9e4a-9d7103deb3ed
begin
x₁, x₄ = coef(ols)[1],coef(ols)[end]
@df mtcars scatter(:WT, :MPG, xlabel="weight (1000s lbs)", ylabel="MPG", leg=false)
@df mtcars plot!(:WT, x₁ .+ x₄*:WT)
end

# ╔═╡ 9282fd88-6ddf-49e2-a154-56c84ed273f1
begin
A = [ones(size(mtcars,1)) mtcars[:,:Disp]  mtcars[:,:HP] mtcars[:,:WT]]
b = mtcars[:,:MPG]
x = A'A \ A'b # solve the normal equation
end

# ╔═╡ fe1ec482-66d9-45ab-9dc0-3556b5e66c4e
z = A \ b # backslash === Az = b

# ╔═╡ 3c02e693-24fc-43d4-9985-327fd5b1e4f1
md"## Detrending"

# ╔═╡ 55a963aa-1df4-4787-9184-f97c15924c04
begin
...
# ╔═╡ 3957b1bc-c598-4dde-9e96-04527163363e
begin
...
# ╔═╡ 1087bebf-6935-4ac8-a369-ed30e98f4838
begin
T = nrow(dfg)
t = collect(1:T)
A1 = [ones(T)  t]
...
# ╔═╡ 58eb413e-a975-4818-ae6c-19aff37da622
# least square solution
α, β = A1\b1

# ╔═╡ 212835af-d680-43f6-b135-12c0d3154d8a
begin
...
# ╔═╡ ef72b4d0-6269-4bf5-b586-4fca121a495d
